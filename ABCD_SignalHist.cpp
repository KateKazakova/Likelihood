 ...
 void ABCD_SignalHist(){
  ...
  for(int i = 0; i < N; i++){
     ...
     if(new_ftempname.Contains("MC16a")){
             if ((ph_iso_et40 - 0.022*ph_pt) < MinCut && ph_isem == 0 && ph_iso_pt/ph_pt < 0.05) hist_A->Fill(ph_phi, lumi_mc16a*sum_koef*weight/(sumw_MC16));
             else if((ph_iso_et40 - 0.022*ph_pt) > MediumCut && (ph_iso_et40 - 0.022*ph_pt) < MaxCut && ph_isem == 0 && ph_iso_pt/ph_pt > 0.05) hist_B->Fill(ph_phi, lumi_mc16a*sum_koef*weight/(sumw_MC16));
             else if((ph_iso_et40 - 0.022*ph_pt) < MinCut && (ph_isem != 0 && (ph_isem & Loose) == 0 ) && ph_iso_pt/ph_pt < 0.05) hist_C->Fill(ph_phi, lumi_mc16a*sum_koef*weight/(sumw_MC16));
             else if((ph_iso_et40 - 0.022*ph_pt) > MediumCut && (ph_iso_et40 - 0.022*ph_pt) < MaxCut && (ph_isem != 0 && (ph_isem & Loose) == 0 ) && ph_iso_pt/ph_pt > 0.05) hist_D->Fill(ph_phi, lumi_mc16a*sum_koef*weight/(sumw_MC16));
     }
    else if(new_ftempname.Contains("MC16d")){
            if ((ph_iso_et40 - 0.022*ph_pt) < MinCut && ph_isem == 0 && ph_iso_pt/ph_pt < 0.05) hist_A->Fill(ph_phi, lumi_mc16d*sum_koef*weight/(sumw_MC16));
            else if((ph_iso_et40 - 0.022*ph_pt) > MediumCut && (ph_iso_et40 - 0.022*ph_pt) < MaxCut && ph_isem == 0 && ph_iso_pt/ph_pt > 0.05) hist_B->Fill(ph_phi, lumi_mc16d*sum_koef*weight/(sumw_MC16));
            else if((ph_iso_et40 - 0.022*ph_pt) < MinCut && (ph_isem != 0 && (ph_isem & Loose) == 0 ) && ph_iso_pt/ph_pt < 0.05) hist_C->Fill(ph_phi, lumi_mc16d*sum_koef*weight/(sumw_MC16));
            else if((ph_iso_et40 - 0.022*ph_pt) > MediumCut && (ph_iso_et40 - 0.022*ph_pt) < MaxCut && (ph_isem != 0 && (ph_isem & Loose) == 0 ) && ph_iso_pt/ph_pt > 0.05) hist_D->Fill(ph_phi, lumi_mc16d*sum_koef*weight/(sumw_MC16));
     }
    else if(new_ftempname.Contains("MC16e")){
            if ((ph_iso_et40 - 0.022*ph_pt) < MinCut && ph_isem == 0 && ph_iso_pt/ph_pt < 0.05) hist_A->Fill(ph_phi, lumi_mc16e*sum_koef*weight/(sumw_MC16));
            else if((ph_iso_et40 - 0.022*ph_pt) > MediumCut && (ph_iso_et40 - 0.022*ph_pt) < MaxCut && ph_isem == 0 && ph_iso_pt/ph_pt > 0.05) hist_B->Fill(ph_phi, lumi_mc16e*sum_koef*weight/(sumw_MC16));
            else if((ph_iso_et40 - 0.022*ph_pt) < MinCut && (ph_isem != 0 && (ph_isem & Loose) == 0 ) && ph_iso_pt/ph_pt < 0.05) hist_C->Fill(ph_phi, lumi_mc16e*sum_koef*weight/(sumw_MC16));
            else if((ph_iso_et40 - 0.022*ph_pt) > MediumCut && (ph_iso_et40 - 0.022*ph_pt) < MaxCut && (ph_isem != 0 && (ph_isem & Loose) == 0 ) && ph_iso_pt/ph_pt > 0.05) hist_D->Fill(ph_phi, lumi_mc16e*sum_koef*weight/(sumw_MC16));
    }
