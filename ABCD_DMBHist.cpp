...
/// МК фоны + сигнал
 const char *fname[150] = {
  ...
  /// данные
   const char *fname_data = "/home/katet/Programs/ZnunugammaInclusive/NewDataSamples/data15-18.reproc-30-09-21_checked.root";
...
// if(fabs(met.DeltaPhi(ph)) <= 0.7) continue;
  ...
  void ABCD_DMBHist(){
    ...
    int NBins = 20;
    double Range_L = -3.14, Range_R = 3.14;
    ...
    TH1D *hist_A_data = new TH1D ("data_A", "data_A", NBins, Range_L, Range_R);
    TH1D *hist_B_data = new TH1D ("data_B", "data_B", NBins, Range_L, Range_R);
    TH1D *hist_C_data = new TH1D ("data_C", "data_C", NBins, Range_L, Range_R);
    TH1D *hist_D_data = new TH1D ("data_D", "data_D", NBins, Range_L, Range_R);
    ...
    for(int i = 0; i < N_data; i++){
     ...
     if((ph_iso_et40 - 0.022*ph_pt) < MinCut && ph_isem == 0 && ph_iso_pt/ph_pt < 0.05) hist_A_data->Fill(ph_phi, 1.0);
     else if((ph_iso_et40 - 0.022*ph_pt) > MediumCut && (ph_iso_et40 - 0.022*ph_pt) < MaxCut && ph_isem == 0 && ph_iso_pt/ph_pt > 0.05) hist_B_data->Fill(ph_phi, 1.0);
     else if((ph_iso_et40 - 0.022*ph_pt) < MinCut && (ph_isem != 0 && (ph_isem & Loose) == 0 ) && ph_iso_pt/ph_pt < 0.05) hist_C_data->Fill(ph_phi, 1.0);
     else if((ph_iso_et40 - 0.022*ph_pt) > MediumCut && (ph_iso_et40 - 0.022*ph_pt) < MaxCut && (ph_isem != 0 && (ph_isem & Loose) == 0 ) && ph_iso_pt/ph_pt > 0.05) hist_D_data->Fill(ph_phi, 1.0);
   }
...

{
  ...
  for(int i = 0; i < N_EtoGam; i++){
   ...
   if((ph_iso_et40 - 0.022*ph_pt) < MinCut && ph_isem == 0 && ph_iso_pt/ph_pt < 0.05){
    hist_A_etogam->Fill(ph_phi, weight);
    hist_B_etogam->Fill(ph_phi, weight);
    hist_C_etogam->Fill(ph_phi, weight);
    hist_D_etogam->Fill(ph_phi, weight);
  }
   else if((ph_iso_et40 - 0.022*ph_pt) > MediumCut && (ph_iso_et40 - 0.022*ph_pt) < MaxCut && ph_isem == 0 && ph_iso_pt/ph_pt < 0.05) hist_B_etogam->Fill(ph_phi, weight);
   else if((ph_iso_et40 - 0.022*ph_pt) < MinCut && (ph_isem != 0 && (ph_isem & Loose) == 0 ) && ph_iso_pt/ph_pt < 0.05) hist_C_etogam->Fill(ph_phi, weight);
   else if((ph_iso_et40 - 0.022*ph_pt) > MediumCut && (ph_iso_et40 - 0.022*ph_pt) < MaxCut && (ph_isem != 0 && (ph_isem & Loose) == 0 ) && ph_iso_pt/ph_pt < 0.05) hist_D_etogam->Fill(ph_phi, weight);
 }
   ...
   cout<<"Sum in region C EtoGam= "<<hist_C_etogam->Integral()<<endl;
    ...
    hist_A_etogam->Scale(2874/hist_A_etogam->Integral());
    hist_B_etogam->Scale(15/hist_A_etogam->Integral());
    hist_C_etogam->Scale(32/hist_A_etogam->Integral());
    hist_D_etogam->Scale(0/hist_A_etogam->Integral());
    ...
    double hist_A_etogam_err = 11, hist_B_etogam_err = 0.05, hist_C_etogam_err = 0.11, hist_D_etogam_err = 0;
    ...
    TH1D *hist_A = new TH1D ("bkg_A", "bkg_A", NBins, Range_L, Range_R);
    TH1D *hist_B = new TH1D ("bkg_B", "bkg_B", NBins, Range_L, Range_R);
    TH1D *hist_C = new TH1D ("bkg_C", "bkg_C", NBins, Range_L, Range_R);
    TH1D *hist_D = new TH1D ("bkg_D", "bkg_D", NBins, Range_L, Range_R);
  ...
  for(int i = 0; i < N; i++){
    ...
    if(new_ftempname.Contains("MC16a")){
      if((ph_iso_et40 - 0.022*ph_pt) < MinCut && ph_isem == 0 && ph_iso_pt/ph_pt < 0.05) hist_A->Fill(ph_phi, lumi_mc16a*sum_koef*weight/(sumw_MC16a));
      else if((ph_iso_et40 - 0.022*ph_pt) > MediumCut && (ph_iso_et40 - 0.022*ph_pt) < MaxCut && ph_isem == 0 && ph_iso_pt/ph_pt > 0.05) hist_B->Fill(ph_phi, lumi_mc16a*sum_koef*weight/(sumw_MC16a));
      else if((ph_iso_et40 - 0.022*ph_pt) < MinCut && (ph_isem != 0 && (ph_isem & Loose) == 0 ) && ph_iso_pt/ph_pt < 0.05) hist_C->Fill(ph_phi, lumi_mc16a*sum_koef*weight/(sumw_MC16a));
      else if((ph_iso_et40 - 0.022*ph_pt) > MediumCut && (ph_iso_et40 - 0.022*ph_pt) < MaxCut && (ph_isem != 0 && (ph_isem & Loose) == 0 ) && ph_iso_pt/ph_pt > 0.05) hist_D->Fill(ph_phi, lumi_mc16a*sum_koef*weight/(sumw_MC16a));
    }
   else if(new_ftempname.Contains("MC16d")){
     if((ph_iso_et40 - 0.022*ph_pt) < MinCut && ph_isem == 0 && ph_iso_pt/ph_pt < 0.05) hist_A->Fill(ph_phi, lumi_mc16d*sum_koef*weight/(sumw_MC16a));
     else if((ph_iso_et40 - 0.022*ph_pt) > MediumCut && (ph_iso_et40 - 0.022*ph_pt) < MaxCut && ph_isem == 0 && ph_iso_pt/ph_pt > 0.05) hist_B->Fill(ph_phi, lumi_mc16d*sum_koef*weight/(sumw_MC16a));
     else if((ph_iso_et40 - 0.022*ph_pt) < MinCut && (ph_isem != 0 && (ph_isem & Loose) == 0 ) && ph_iso_pt/ph_pt < 0.05) hist_C->Fill(ph_phi, lumi_mc16d*sum_koef*weight/(sumw_MC16a));
     else if((ph_iso_et40 - 0.022*ph_pt) > MediumCut && (ph_iso_et40 - 0.022*ph_pt) < MaxCut && (ph_isem != 0 && (ph_isem & Loose) == 0 ) && ph_iso_pt/ph_pt > 0.05) hist_D->Fill(ph_phi, lumi_mc16d*sum_koef*weight/(sumw_MC16a));
   }
   else if(new_ftempname.Contains("MC16e")){
     if((ph_iso_et40 - 0.022*ph_pt) < MinCut && ph_isem == 0 && ph_iso_pt/ph_pt < 0.05) hist_A->Fill(ph_phi, lumi_mc16e*sum_koef*weight/(sumw_MC16a));
     else if((ph_iso_et40 - 0.022*ph_pt) > MediumCut && (ph_iso_et40 - 0.022*ph_pt) < MaxCut && ph_isem == 0 && ph_iso_pt/ph_pt > 0.05) hist_B->Fill(ph_phi, lumi_mc16e*sum_koef*weight/(sumw_MC16a));
     else if((ph_iso_et40 - 0.022*ph_pt) < MinCut && (ph_isem != 0 && (ph_isem & Loose) == 0 ) && ph_iso_pt/ph_pt < 0.05) hist_C->Fill(ph_phi, lumi_mc16e*sum_koef*weight/(sumw_MC16a));
     else if((ph_iso_et40 - 0.022*ph_pt) > MediumCut && (ph_iso_et40 - 0.022*ph_pt) < MaxCut && (ph_isem != 0 && (ph_isem & Loose) == 0 ) && ph_iso_pt/ph_pt > 0.05) hist_D->Fill(ph_phi, lumi_mc16e*sum_koef*weight/(sumw_MC16a));
   }
  ...
  const char *fOutName = "/home/katet/Programs/ABCD/TRooFit/demo/Liklehood/Liklehood_DMB.root";
